...
#### ARCANE LEXICON
Effort: Scene. Lasts 1 scene. Read any script not intentionally obfuscated.

#### COUNTER MAGIC:
Effort: Day. Instant Action. Limit: 1/Round. When a visible mage casts a spell, make opposed Magic checks. Success: The spell fails & is wasted. Works only on spells.

#### EMPOWERED SORCERY
Effort: Day. Instant Action. Reroll any die associated w/ a spell's effect. Take the preferred.

#### HANG SORCERY
Effort: Scene. Instant Action. A cast spell remains & can be triggered as an On Turn Action. Damage does not disrupt the spell. No additional spells can be cast until the spell is triggered or released.

#### INEXORABLE EFFECT
Effort: Day. Instant Action. 1/scene. Force a foe to reroll a successful save & take the worse result.

#### IRON RESOLUTION
Effort: Day. When injured or disturbed in combat, make a Phys Save to resist spell disruption.

#### PREPARATORY COUNTERMAGIC
Effort: Scene. Remain unaffected by the direct effects of a spell you've prepped.

#### PSYCHIC CONVERSION
Effort: Day. On Turn Action. Expend a casting slot to remove 1 point of Strain & heal 2HP x level.

#### RESTRAINED CASTING
Effort: Day. Instant Action. Cast a High Magic spell silently & w/o somatic gestures.

#### RETAIN SORCERY
Effort: Day. On Turn Action. Limit: 1/day. A cast spell does not count against your daily limit.

#### SENSE MAGIC
Effort: Indefinite. Instant Action. While Commited you see magic & gain a short description of its effect.

#### SUPPRESS MAGIC
Effort: Day. Lasts 1d6 Rounds + Caster level. Range: 100'. AoE: 20' radius. On Turn Action. Suppress a visible or known magical effect. If caster was of ≤ HD: effect is dispelled. If caster was of > HD: roll opposed Magic check. > Caster: +2 bonus. Dispeller wins ties. 1 attempt.

#### SWIFT CASTING
Effort: Day. 1/scene. Turn a spell requiring a Main Action into an On Turn Action. No other spell may be cast this Round. This Art can't be used if you've already cast this Round, or have been disqualified from casting.

#### WARD ALLIES
Effort: Day. Instant Action. Omit ≤ 6 allies from the effects of an AoE spell you've cast. This does not protect them from indirect consequences of the spell.

#### WIZARD'S GRANDEUR
Effort: Indefinite. On Turn Action. While Commited you can't be made unkempt or unclean. Noxious substances slide off & you remain comfortable enough to receive the benefits of a Night's rest regardless of climate or shelter.
