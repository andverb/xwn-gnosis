...
EN_SECTION_MAP = {
    ...
    "Magic": ("magic", "magic-basics.md"),
    "Elixirs": ("magic", "elixirs.md"),
    "Magical Devices": ("magic", "magical-devices.md"),
    ...
    "Arcane Tradition of the High Mage": ("magic/traditions", "high-mage.md"),
    "Arcane Tradition of the Druid": ("magic/traditions", "druid.md"),
    "Arcane Tradition of the Elementalist": ("magic/traditions", "elementalist.md"),
    "Arcane Tradition of the Necromancer": ("magic/traditions", "necromancer.md"),
    "Arcane Tradition of the Bard (Half Class)": ("magic/traditions", "bard.md"),
    "Arcane Tradition of the Cleric (Half Class)": ("magic/traditions", "cleric.md"),
    "Arcane Tradition of the Monk (Half Class)": ("magic/traditions", "monk.md"),
    "Arcane Tradition of the Beastmaster (Half Class)": ("magic/traditions", "beastmaster.md"),
    "Arcane Tradition of the Warlock (Half Class)": ("magic/traditions", "warlock.md"),
...
UK_SECTION_MAP = {
    ...
    "Чари": ("magic", "magic-basics.md"),
    "Еліксири": ("magic", "elixirs.md"),
    "Магічні Пристрої": ("magic", "magical-devices.md"),
    ...
    "Арканна Традиція Вищих Магів": ("magic/traditions", "high-mage.md"),
    "Арканна Традиція Друїда": ("magic/traditions", "druid.md"),
    "Арканна Традиція Елементаліста": ("magic/traditions", "elementalist.md"),
    "Арканна Традиція Некроманта": ("magic/traditions", "necromancer.md"),
    "Арканна Традиція Барда (Напівклас)": ("magic/traditions", "bard.md"),
    "Арканна Традиція Клірика (Напівклас)": ("magic/traditions", "cleric.md"),
    "Арканна Традиція Монаха (Напівклас)": ("magic/traditions", "monk.md"),
    "Арканна Традиція Приборкувача Звірів (Напівклас)": ("magic/traditions", "beastmaster.md"),
    "Арканна Традиція Чаклуна (Напівклас)": ("magic/traditions", "warlock.md"),
